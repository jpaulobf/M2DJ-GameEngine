...
public class TreeTrunk  extends SpriteImpl {
    ...
    public void draw(long frametime) {
        this.spriteColRef.getG2D().drawImage(this.trunk, (int)this.positionX, (int)this.positionY + this.scenarioOffsetY, (int)(this.positionX + this.trunk.getWidth()), (int)(this.positionY + this.height + this.scenarioOffsetY), //dest w1, h1, w2, h2
